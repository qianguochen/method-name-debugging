...
lock = threading.Lock()
# 设置API访问参数
api_key = "sk-wzjpYm0q0BcAiJxB773bC94cBcE643B1Aa42294993073fAd"
...
def task(question, line, fail_line):
    try:
        ...
        try:
            with open('total_result_batch_three.csv', 'a') as file1:
...
def read_file_lines(file_path):
    ...
    with open(file_path, 'r', encoding='utf-8') as file:
        for line in file:
            count_line += 1
            if count_line < 1954670 or count_line > 2310000:
                continue
            global count
