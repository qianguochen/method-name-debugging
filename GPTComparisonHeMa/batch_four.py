...
lock = threading.Lock()
# 设置API访问参数
api_key = "sk-46zW1wLChXIGEEu0747f77Df565a414a80F75c113528F207"
...
def task(question, line, fail_line):
    try:
        ...
        try:
            with open('total_result_batch_four.csv', 'a') as file1:
...
def read_file_lines(file_path):
    ...
    with open(file_path, 'r', encoding='utf-8') as file:
        for line in file:
            count_line += 1
            if count_line < 2323206 or count_line > 2680000:
                continue
            global count
