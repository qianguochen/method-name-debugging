...
lock = threading.Lock()
# 设置API访问参数
api_key = "sk-TLhsaO3qqyKs5D9o663fDa25247c4090A87cCe8bF3A17d9b"
api_url = "https://ngapi.xyz/v1/chat/completions"
...
def task(question, line, fail_line):
    try:
        ...
        try:
            with open('total_result_batch_five.csv', 'a') as file1:
...
def read_file_lines(file_path):
    ...
    with open(file_path, 'r', encoding='utf-8') as file:
        for line in file:
            count_line += 1
            if count_line < 2691359 or count_line > 3050000:
                continue
            global count
