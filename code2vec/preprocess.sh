...
TRAIN_DIR=/root/Desktop/work/code2vec
VAL_DIR=/root/Desktop/work/rocketmq
TEST_DIR=/root/Desktop/work/JavaRepos
DATASET_NAME=my_dataset_level_2
MAX_CONTEXTS=200
...
${PYTHON} JavaExtractor/extract.py --dir ${VAL_DIR} --max_path_length 8 --max_path_width 2 --num_threads ${NUM_THREADS} --method_level 2 --jar ${EXTRACTOR_JAR} > ${VAL_DATA_FILE}
echo "Finished extracting paths from validation set"
echo "Extracting paths from test set..."
${PYTHON} JavaExtractor/extract.py --dir ${TEST_DIR} --max_path_length 8 --max_path_width 2 --num_threads   ${NUM_THREADS} --method_level 2 --jar ${EXTRACTOR_JAR} > ${TEST_DATA_FILE}
echo "Finished extracting paths from test set"
echo "Extracting paths from training set..."
${PYTHON} JavaExtractor/extract.py --dir ${TRAIN_DIR} --max_path_length 8 --max_path_width 2 --num_threads ${NUM_THREADS} --method_level 2 --jar ${EXTRACTOR_JAR} | shuf > ${TRAIN_DATA_FILE}
