...
def ExtractFeaturesForDir(args, dir, prefix):
    command = ['java', '-cp', args.jar, 'JavaExtractor.App',
               ...
               '--dir', dir, '--num_threads', str(args.num_threads),'--method_level', str(args.method_level)]
...
if __name__ == '__main__':
    ...
    parser.add_argument("-methodlevel", "--method_level", dest="method_level", required=False, default=1)
